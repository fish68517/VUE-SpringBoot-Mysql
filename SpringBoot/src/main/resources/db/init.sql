...
('河南省郑州市', 28.5, 65, 0.0, 3.2, '晴天', '2026-02-20 14:00:00'),
('山东省济南市', 25.3, 72, 2.5, 4.1, '多云', '2026-02-20 14:30:00'),
('北京市朝阳区', 22.1, 58, 0.0, 2.8, '晴天', '2026-02-20 15:00:00'),
('上海市浦东新区', 26.7, 68, 5.2, 3.5, '小雨', '2026-02-20 15:30:00'),
('江苏省南京市', 24.9, 70, 1.8, 3.9, '阴天', '2026-02-20 16:00:00'),
('浙江省杭州市', 27.2, 62, 0.0, 2.5, '晴天', '2026-02-20 16:30:00');

-- 插入预警数据
INSERT INTO warnings (warning_type, region, severity, description, start_time, end_time, status) VALUES
('暴雨', '河南省郑州市', 'high', '未来24小时内可能出现暴雨，请做好防护准备', '2026-02-21 08:00:00', '2026-02-22 08:00:00', 'active'),
('冰雹', '山东省济南市', 'critical', '预计明天下午可能出现冰雹，请立即采取防护措施', '2026-02-21 10:00:00', '2026-02-21 18:00:00', 'active'),
('大风', '北京市朝阳区', 'medium', '明天风力较大，请加固农作物支架', '2026-02-21 12:00:00', '2026-02-22 12:00:00', 'active'),
('霜冻', '江苏省南京市', 'high', '后天早晨可能出现霜冻，请做好保温工作', '2026-02-22 06:00:00', '2026-02-22 12:00:00', 'active'),
('干旱', '浙江省杭州市', 'medium', '近期降水较少，建议及时灌溉', '2026-02-20 00:00:00', '2026-03-05 00:00:00', 'active'),
('洪涝', '上海市浦东新区', 'high', '预计本周降水量较大，请做好排水准备', '2026-02-21 00:00:00', '2026-02-25 00:00:00', 'active');
...
('小麦', '拔节期', '河南省郑州市', 1, '2023-10-15', '2026-06-01'),
('玉米', '苗期', '山东省济南市', 2, '2026-04-01', '2026-10-15'),
('水稻', '分蘖期', '江苏省南京市', 6, '2026-05-01', '2026-10-01'),
('大豆', '开花期', '河南省郑州市', 1, '2026-05-15', '2026-10-30'),
('棉花', '苗期', '山东省济南市', 2, '2026-04-20', '2026-11-15'),
('蔬菜', '生长期', '北京市朝阳区', 1, '2026-02-01', '2026-05-01');
...
('ORD20260220001', 1, 1, 2, 179.98, 'paid', '支付宝', '河南省郑州市中原区农业路123号'),
('ORD20260220002', 2, 2, 1, 199.99, 'shipped', '微信支付', '山东省济南市历下区泉城路456号'),
('ORD20260220003', 6, 4, 3, 389.97, 'pending', '银行转账', '江苏省南京市鼓楼区中山路789号'),
('ORD20260220004', 1, 3, 5, 227.50, 'delivered', '支付宝', '河南省郑州市金水区文化路321号'),
('ORD20260220005', 2, 5, 1, 299.99, 'paid', '微信支付', '山东省济南市槐荫区经十路654号'),
('ORD20260220006', 6, 6, 1, 1299.99, 'pending', '银行转账', '江苏省南京市浦口区浦珠路987号');
