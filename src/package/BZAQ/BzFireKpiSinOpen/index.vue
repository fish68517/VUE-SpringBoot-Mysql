<template>
  <div class="bz-fire-kpi-open" @click="openFireKpiList">
  </div>
</template>
...
const sourceName = 'BzFireKpiSinOpen'
const payload = {
  diaName: 'fire-kpi-list'
}
...
function openFireKpiList() {
  eventBus.emit('OPEN_FIRE_KPI_DIA', payload)
}
</script>

<script lang="ts">
export default {
  name: 'BzFireKpiSinOpen',
  version: '1.0.0'
}
</script>
