...
import { BzGreenFireDia } from './index'
...
export const option = {
  ...
  usePublicParam: true,
  enablePopup: true,
  // 事件列表配置（搬运自 YZEventBox，后续会替换）
  eventListApi: 'http://23.99.16.86:11001/api/v1/system/smartRisk/popup/eventList',
  eventRequestMethod: 'post',
  enableEventTypeSearch: true,
...
export default class Config extends PublicConfigClass implements CreateComponentType {
  public key = BzGreenFireDia.key
  public chartConfig = cloneDeep(BzGreenFireDia)
  // 图表配置项
