...
const riskLabelMap = {
  'risk-high-building': '地灾隐患点',
  'risk-nine-small': '危险房屋',
}

const riskTypeOptions = [
  { label: '地灾隐患点', value: 'risk-high-building' },
  { label: '危险房屋', value: 'risk-nine-small' },
]
...
const columns = [
  ...
  { title: '风险点名称', key: 'name', width: 200},
  { title: '风险点类型', key: 'type', width: 120,}
]
const heightColumns = [
  {
    title: '序号',
...
const activeColumns = computed(() => selectedType.value === 'risk-high-building' ? heightColumns : columns)

// 表格固定横向滚动宽度，列多时通过横向滚动完整展示。
const tableScrollX = 600
