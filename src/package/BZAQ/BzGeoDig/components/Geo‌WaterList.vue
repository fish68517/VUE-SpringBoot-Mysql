...
const columns = [
  ...
  { title: '隐患点类型', key: 'type', width: 160},
  { title: '地理位置', key: 'location', width: 220, },
  { title: '最后修改时间', key: 'lastModifiedTs', width: 220 },
]

// 表格横向滚动宽度大于弹窗内容区时，Naive UI 才会生成横向滚动条。
...
const requestRiskList = async () => {
  let api = "/api/boot/system/land/landRainXlyImagePage"
...
:deep(.fire-table) {
  ...
  .n-scrollbar-rail__scrollbar {
    background: rgba(83, 174, 255, 0.65) !important;
  }
}
