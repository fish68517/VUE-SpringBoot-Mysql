...
import { RequestConfigType } from './index.d'
import { groupTitle, chartInitConfig, chartInitNewAttrConfig } from '../config/const'
...
export class PublicConfigClass implements PublicConfigType {
  ...
  // 新增属性
  public newAttr: newAttrInter = chartInitNewAttrConfig
}
