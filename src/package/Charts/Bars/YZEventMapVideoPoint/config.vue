<template>
  ...
  <GlobalSetting :is-use-custom="true" :tabData="tabData">
    <template #other>
      <div>所属区域：<input v-model="props.optionData.ZbAddress"/></div>
      <div style="margin-top: 10px; display: flex; align-items: center;">
        <span style="margin-right: 8px;">是否本质安全：</span>
        <input type="checkbox" v-model="props.optionData.isEssentialSafe" />
      </div>
    </template>
  </GlobalSetting>
</template>
