...
INSERT INTO `cart` VALUES (3, 5, 5, 1, '2025-11-23 10:54:13', '2025-11-23 10:54:13');
...
-- ----------------------------
INSERT INTO `community_post` VALUES (1, 4, '求助！新手养猫需要准备什么？', '刚捡了一只小橘猫，大概两个月大，请问各位大神需要买什么用品？', '[\"post1.jpg\"]', 25, 300, 0, '2025-11-23 10:54:14', '2025-11-23 10:54:14');
INSERT INTO `community_post` VALUES (2, 5, '晒晒我家的金毛', '周末带狗狗去公园玩，它笑得好开心呀！', '[\"post2_1.jpg\", \"post2_2.jpg\"]', 108, 1200, 0, '2025-11-23 10:54:14', '2025-11-23 10:54:14');
...
INSERT INTO `community_post` VALUES (4, 2, '店铺上新活动预告', '快乐宠屋下周一有大促，全场8折，欢迎选购！', '[\"promo.jpg\"]', 12, 150, 0, '2025-11-23 10:54:14', '2025-11-23 10:54:14');
...
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '社区评论表' ROW_FORMAT = Dynamic;
...
INSERT INTO `community_reply` VALUES (3, 2, 4, '大金毛太暖了，好想摸摸！', '2025-11-23 10:54:14');
INSERT INTO `community_reply` VALUES (4, 2, 7, '这毛色真亮，平时喂什么？', '2025-11-23 10:54:14');
...
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '宠物档案表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '帖子点赞表' ROW_FORMAT = Dynamic;
...
INSERT INTO `post_like` VALUES (3, 2, 4, '2025-11-23 10:54:14');
INSERT INTO `post_like` VALUES (4, 2, 7, '2025-11-23 10:54:14');
INSERT INTO `post_like` VALUES (5, 2, 1, '2025-11-23 10:54:14');
...
INSERT INTO `product` VALUES (3, 2, 3, '宠物冻干鸡胸肉 500g', '纯肉制作，无添加，猫狗通用。', 45.00, 200, 'https://api.example.com/products/p3.jpg', '[\"p3_1.jpg\"]', 1, 300, '2025-11-23 10:54:13', '2025-11-23 10:54:13');
...
INSERT INTO `product` VALUES (5, 3, 4, '伯纳天纯鸭肉梨狗粮 15kg', '去泪痕配方，大包装更实惠。', 450.00, 20, 'https://api.example.com/products/p5.jpg', '[\"p5_1.jpg\"]', 1, 15, '2025-11-23 10:54:13', '2025-11-23 10:54:13');
...
-- Records of shop
-- ----------------------------
INSERT INTO `shop` VALUES (1, 2, '快乐宠屋旗舰店', '专注猫狗粮，品质保证，给爱宠最好的呵护。', 'https://api.example.com/shops/logo1.jpg', '021-12345678', 1, '2025-11-23 10:54:12', '2025-11-23 10:54:12');
...
INSERT INTO `shop` VALUES (3, 1, '星落自营店', '官方自营，品质无忧，极速发货。', 'https://api.example.com/shops/logo_official.jpg', '400-8888888', 1, '2025-11-23 10:54:12', '2025-11-23 10:54:12');
