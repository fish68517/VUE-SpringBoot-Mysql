...
) ENGINE = InnoDB AUTO_INCREMENT = 59 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '用户打卡表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '教练资格认证表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of coach_certification
-- ----------------------------
INSERT INTO `coach_certification` VALUES (2, 2, '中国健身教练证书000', '健身协会000', '/uploads/2/80143ed4-ea49-4fb3-bcf3-dbcd7a4a8592.jpg', '2025-12-24', '2025-12-30', 0, '2025-12-08 21:33:09', '2025-12-08 21:34:35');
INSERT INTO `coach_certification` VALUES (4, 2, '258525', '2424', '/uploads/2/e3514d23-014c-4b0a-915f-51fb43d46905.jpeg', '2026-01-02', '2026-01-10', 0, '2025-12-08 21:52:06', '2025-12-08 21:52:06');
...
INSERT INTO `coach_student` VALUES (5, 2, 5, '2025-11-23 09:48:46', '2025-12-26 11:11:45', 1);
...
) ENGINE = InnoDB AUTO_INCREMENT = 26 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '评论表' ROW_FORMAT = Dynamic;
...
INSERT INTO `comment` VALUES (22, '八八八八', 10, 14, '2025-12-03 10:00:35');
INSERT INTO `comment` VALUES (23, 'BBS', 10, 14, '2025-12-03 10:01:08');
INSERT INTO `comment` VALUES (24, '0000', 10, 14, '2025-12-03 10:02:17');
...
-- Records of dynamic
-- ----------------------------
INSERT INTO `dynamic` VALUES (1, '今天完成了我的第100次打卡！坚持健身真的改变了我的生活，感谢小鲨鱼健身平台的陪伴！💪', 'https://api.example.com/images/checkin_100.jpg', 3, 45, 9, 'approved', '2025-11-21 09:48:46', '2025-12-03 15:18:57');
INSERT INTO `dynamic` VALUES (2, '分享一下我的早餐：鸡蛋、燕麦和蓝莓。健身从饮食开始！', 'https://api.example.com/images/breakfast.jpg', 4, 32, 5, 'approved', '2025-11-22 09:48:46', '2025-11-22 09:48:46');
...
INSERT INTO `dynamic` VALUES (14, '222', '/images/ed0d1cbb-f37d-40bb-921e-f4bab18ffad6.png,/images/432a08bf-e518-4826-b62f-fddafb4e6dc6.jpg', 10, 1, 3, 'approved', '2025-12-03 09:20:31', '2025-12-03 10:02:17');
INSERT INTO `dynamic` VALUES (15, '252525', '/images/d95ee37a-f854-4827-be77-d42f8d90fa99.jpg,/images/8e71115e-320e-4433-aab7-58c48e7d3c75.jpeg', 10, 0, 0, 'approved', '2025-12-03 15:18:24', '2025-12-03 15:22:54');
...
INSERT INTO `fitness_resource` VALUES (4, '有氧运动减脂指南', '科学的有氧运动方法，帮助您有效减脂，提高心肺功能', 'video', 'https://api.example.com/videos/cardio_guide.mp4', NULL, 3, 3200, '2025-11-23 09:48:46', '2025-11-23 09:48:46');
...
INSERT INTO `fitness_resource` VALUES (10, '运动恢复的重要性', '详细说明了运动后恢复的重要性，包括睡眠、营养和主动恢复的方法。', 'article', NULL, '恢复和训练同样重要。充足的睡眠（7-9小时）对肌肉生长至关重要。营养恢复包括训练后30分钟内摄入蛋白质和碳水化合物。主动恢复包括轻度有氧运动、拉伸和按摩。', 1, 959, '2025-11-23 09:48:46', '2025-12-03 15:18:48');
INSERT INTO `fitness_resource` VALUES (13, '如何跑步', '如何跑步如何跑步如何跑步如何跑步如何跑步', 'article', '', '如何跑步如何跑步如何跑步如何跑步如何跑步如何跑步', 2, 0, '2025-12-03 15:22:00', '2025-12-03 15:22:00');
...
) ENGINE = InnoDB AUTO_INCREMENT = 39 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '点赞记录表' ROW_FORMAT = Dynamic;
...
INSERT INTO `like_record` VALUES (38, 10, 14, '2025-12-03 09:23:36');
...
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '训练反馈表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of training_feedback
-- ----------------------------
INSERT INTO `training_feedback` VALUES (1, 4, 5, NULL, '2025-12-08', 5, NULL, '00000', NULL, NULL, '2025-12-08 16:42:13');
INSERT INTO `training_feedback` VALUES (2, 5, 10, NULL, '2025-12-08', 5, NULL, '教练太好了', NULL, NULL, '2025-12-08 21:37:34');
INSERT INTO `training_feedback` VALUES (3, 9, 10, NULL, '2025-12-08', 5, NULL, '教练不错', NULL, NULL, '2025-12-08 21:37:43');
INSERT INTO `training_feedback` VALUES (4, 9, 10, NULL, '2025-12-10', 5, NULL, '0000', NULL, NULL, '2025-12-08 21:53:23');
INSERT INTO `training_feedback` VALUES (5, 9, 10, NULL, '2025-12-10', 5, NULL, '88888', NULL, NULL, '2025-12-08 21:53:47');
INSERT INTO `training_feedback` VALUES (7, 1, 10, 3, '2026-01-01', 4, NULL, '你就回家', '哈哈哈哈', '2026-01-01', '2026-01-01 21:55:13');
INSERT INTO `training_feedback` VALUES (8, 1, 10, 3, '2026-01-02', 2, NULL, '刚刚好是不是', '2525252', '2026-01-01', '2026-01-01 22:58:10');
