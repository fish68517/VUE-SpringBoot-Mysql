  ...
  <div class="plan-create-container">
    <div class="plan-create-card">
      ...
      >
        ...
        <!-- 计划描述 -->
        <el-form-item label="计划描述" prop="description" class="description-item">
          <div class="form-field-wrapper description-wrapper">
            <el-input
...
.description-wrapper :deep(.el-textarea__inner) {
  min-height: 140px;
  line-height: 1.8;
}
