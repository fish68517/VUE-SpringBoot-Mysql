    ...
    <div class="statistics-grid">
      <el-card class="stat-card">
        <div class="stat-content">
          ...
          <div class="stat-label">申请总人数</div>
        </div>
      </el-card>
...
import { getSchoolStatistics } from '@/api/schoolAdmin'
      ...
      series: [
        {
          ...
          radius: '50%',
          data: [
            { value: statistics.value.approvedApplications, name: '已通过' },
