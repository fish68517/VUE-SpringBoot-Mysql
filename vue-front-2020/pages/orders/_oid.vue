    ...
    <form name="flowForm" id="flowForm" method="post" action="">
      ...
      <div class="Finish">
        <div class="fr" id="AgreeDiv">
          ...
          <label for="Agree"><p class="on"><input type="checkbox" checked="checked">我已阅读并同意<a href="javascript:" target="_blank">《在线学院购买协议》</a></p></label>
        </div>
        <div class="clear"></div>
        <div class="Main fl">
          <div class="fl">
...
export default {
    ...
    methods:{
        //保存订单
        saveOrder() {
          ordersApi.createOrders(this.order.courseId).then(response => {
            //获取返回订单号
            //生成订单之后，跳转订单显示页面
        ...
        toPay() {
          this.$router.push({
            ...
            query: {
              ...
              subject: this.order.courseTitle, // 添加课程标题
              totalAmount: this.order.totalFee
            }
          })
        }
    }
