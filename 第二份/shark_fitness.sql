...
) ENGINE = InnoDB AUTO_INCREMENT = 14 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '教练-学生关系表' ROW_FORMAT = Dynamic;
...
INSERT INTO `coach_student` VALUES (13, 2, 11, '2026-03-16 13:33:20', '2026-04-16 05:33:20', 1);
...
) ENGINE = InnoDB AUTO_INCREMENT = 17 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '社区动态表' ROW_FORMAT = Dynamic;
...
INSERT INTO `dynamic` VALUES (16, '0000', '/images/336b8129-f25a-4699-b604-7ba877d0e7ab.jpeg', 10, 0, 0, 'pending', '2026-03-16 12:52:11', '2026-03-16 12:52:11');
...
-- ----------------------------
INSERT INTO `fitness_resource` VALUES (1, '初级健身入门教程000', '适合健身初学者的基础训练教程，包括热身、基本动作和放松', 'video', 'https://api.example.com/videos/beginner_tutorial.mp4', '', 1, 1266, '2025-11-23 09:48:46', '2026-03-16 12:47:58');
...
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '训练反馈表' ROW_FORMAT = Dynamic;
...
INSERT INTO `training_feedback` VALUES (7, 1, 10, 3, '2026-01-01', 4, NULL, '你就回家', '哈哈哈哈00', '2026-03-16', '2026-01-01 21:55:13', NULL, NULL, NULL);
...
INSERT INTO `training_feedback` VALUES (11, 1, 10, 2, '2026-03-16', 5, 'normal', '00', NULL, NULL, '2026-03-16 12:32:21', '/documents/f27dbb69-c4a9-406c-9117-856ed1fc29fd.docx', '/images/809c13af-85a5-4c8c-adae-a2cd3d191674.jpeg', '/static/videos/604efce9-f554-4655-b34c-a6a84f091402.mp4');
...
INSERT INTO `user` VALUES (11, 'demotest', '12345678', 'user', NULL, NULL, NULL, '2026-03-16 13:32:51', '2026-03-16 13:32:51');
