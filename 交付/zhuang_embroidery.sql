...
-- ----------------------------
INSERT INTO `knowledge` VALUES (1, '文山壮族刺绣的色彩美学与文化内涵', '文山壮族刺绣偏爱强烈的对比色，如黑底红花、蓝底白花，这与壮族先民的自然崇拜和生命意识息息相关...', '历史文化', '文山州文化局', 328, '2026-02-15 08:28:43', '2026-02-16 09:15:43');
INSERT INTO `knowledge` VALUES (2, '零基础入门：平绣的基本针法与图解', '平绣是文山壮族刺绣中最基础的技法，要求针脚齐整、线条流畅。本文将通过图文并茂的方式教你起针与收针...', '技法知识', '农师傅', 512, '2026-02-15 08:28:43', '2026-02-15 08:28:43');
...
-- Records of news
-- ----------------------------
INSERT INTO `news` VALUES (1, '2026年文山州文山壮族刺绣文化艺术节即将开幕', '据悉，本次艺术节将于文山市广场举行，届时将展出超过500件珍贵的刺绣老物件，并有非遗传承人现场技艺展示...', '文山日报', '2026-02-15 08:28:44', '2026-02-15 08:28:44');
...
-- Records of topic
-- ----------------------------
INSERT INTO `topic` VALUES (1, '【探讨】如何让文山壮族刺绣走进年轻人的日常衣柜？', '大家觉得传统的刺绣图案放在卫衣、帆布鞋或者手机壳上好看吗？欢迎分享你们的创意！', 1, 1, '2026-02-15 08:28:43', '2026-02-15 08:28:43');
...
-- Records of vote
-- ----------------------------
INSERT INTO `vote` VALUES (1, '你最喜欢的文山壮族刺绣代表性图腾是哪一个？', '我们将根据投票结果，选取最高票的图腾推出文创周边。', '[\"太阳纹\", \"青蛙纹\", \"八角星纹\", \"花蝶纹\"]', 'active', '2026-02-15 08:28:43', '2026-12-31 23:59:59');
